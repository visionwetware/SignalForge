  ...
  return (
    <div className="max-w-5xl mx-auto px-6 md:px-12 py-12 pb-24">
      <PageHeader
        ...
        title="Every signal you've forged"
      ...
      {loading ? (
        <div className="text-[#1A1814]/40">Loading…</div>
      ) : results.length === 0 ? (
        <div className="border border-dashed border-[#1A1814]/15 rounded-lg p-12 text-center text-[#1A1814]/50 bg-white/20">
