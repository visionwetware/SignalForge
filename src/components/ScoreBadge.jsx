...
const VERDICT_STYLES = {
  ...
  inconclusive: { color: "#E6F7FF", label: "Inconclusive" },
};
    ...
    <div className="flex items-center gap-3">
      <div className="relative" style={{ width: wh, height: wh }}>
        <svg width={wh} height={wh} className="-rotate-90">
          <circle cx={wh / 2} cy={wh / 2} r={radius} stroke="#E6F7FF" strokeOpacity="0.08" strokeWidth={stroke} fill="none" />
          <circle
      ...
      {size !== "sm" && (
        <div>
          <div className="text-[10px] uppercase tracking-[0.18em] text-[#E6F7FF]/50">Verdict</div>
